...
//  Description   : Display on Screen Count Numbers Less than given number.
...
int DisplayLess(PNODE first, int no)
{
    printf("In List %d number Less than numbers are : \n",no);
    while (first != NULL)
    {
        if(first->Data < no)
        {
...
//           Enter a Number : 26
//
//           In List 26 number Less than numbers are : 
//           | 20 |-> | 25 |->
//              
